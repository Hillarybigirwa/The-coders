...
?>
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "Ugx:"." ".$row['productPrice']; ?>/=</span></td>
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "Ugx:"." ".$row['shippingCharge']; ?>/=</span></td>

					<td class="cart-product-grand-total"><span class="cart-grand-total-price">Ugx:<?php echo ($_SESSION['cart'][$row['id']]['quantity']*$row['productPrice']+$row['shippingCharge']); ?>/=</span></td>
				</tr>
